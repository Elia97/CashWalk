    ...
    <form onSubmit={form.handleSubmit(handleAddCategory)}>
      <FieldGroup>
        ...
        <FieldSet>
          ...
          <FieldDescription>
            First, choose if this is income or expense, then pick a parent category.
          </FieldDescription>
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="relative flex-1">
                  <FieldContent>
                    ...
                    <FieldDescription>Is this money coming in or going out?</FieldDescription>
                  </FieldContent>
              ...
              render={({ field, fieldState }) => {
                ...
                return (
                  <Field data-invalid={fieldState.invalid} className="relative flex-1">
                    <FieldContent>
                      <FieldLabel htmlFor={field.name}>{capitalize(field.name)}</FieldLabel>
                      <FieldDescription>Which main category does this belong to?</FieldDescription>
                    </FieldContent>
                    <Select value={field.value} onValueChange={field.onChange}>
                      <SelectTrigger id={field.name} aria-invalid={fieldState.invalid}>
        ...
        <FieldSet>
          ...
          <FieldDescription>Pick an icon and give your category a name.</FieldDescription>
          <Field orientation={'responsive'}>
            <Controller
              name="icon"
              control={form.control}
        ...
        <DialogFooter>
          <Field orientation="horizontal" className="mt-4">
            ...
            <Button type="submit" className="flex-1" disabled={form.formState.isSubmitting}>
              <LoadingSwap isLoading={form.formState.isSubmitting}>Add Category</LoadingSwap>
            </Button>
          </Field>
        </DialogFooter>
      </FieldGroup>
