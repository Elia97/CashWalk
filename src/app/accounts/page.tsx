...
import { getAllUserBankAccounts } from './actions/bank-account-actions';
...
export default async function AccountsPage() {
  ...
  const res = await getAllUserBankAccounts(session.user.id);
  ...
  return (
    <section className="animate-fade-up">
      ...
      {res.data && <BankAccountManagement accounts={res.data} isAdmin={isAdmin} />}
    </section>
  );
}
